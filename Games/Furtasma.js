...
class Page
{
   ...
   load()
   {
      ...
      for(var key in this.actions)
      {
         ...
         btn.addEventListener('click',Scenario.pages[act.link].load,false);
...
Scenario.pages =
   {
      START: new Page
         ({
           text:"This is the start test to see if it'll load in any of the text at all. Also, this is test what, 12?",
           actions:
            {
